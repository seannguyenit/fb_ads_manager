...
const adminEmail = 'support@m2v.me'
...
//     html: `<h3>Chao mừng bạn đã đăng ký m2v.me</h3><div>Bấm vào link để kích hoạt tài khoản: </div><a target="_blank" href="https://m2v.me/account/activate/${key_active}">Kích hoạt</a>` // Phần nội dung mail mình sẽ dùng html thay vì thuần văn bản thông thường.
//   }
...
const sendMail = (to, key_active) => {
  ...
  const options = {
    from: adminEmail, // địa chỉ admin email bạn dùng để gửi
    to: to, // địa chỉ gửi đến
    subject: 'Đăng ký thành công m2v.me', // Tiêu đề của mail
    html: `<h3>Chao mừng bạn đã đăng ký m2v.me</h3><div>Bấm vào link để kích hoạt tài khoản: </div><a target="_blank" href="https://m2v.me/account/activate/${key_active}">Kích hoạt</a>` // Phần nội dung mail mình sẽ dùng html thay vì thuần văn bản thông thường.
  }
